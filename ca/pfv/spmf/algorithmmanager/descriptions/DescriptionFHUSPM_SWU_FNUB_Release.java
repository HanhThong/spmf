...
import ca.pfv.spmf.algorithms.sequentialpatterns.FHUSPM.FHUSPM_SWU_FNUB_Release;

public class DescriptionFHUSPM_SWU_FNUB_Release extends DescriptionOfAlgorithm {
    public DescriptionFHUSPM_SWU_FNUB_Release() {
    }

    @Override
    public String getName() {
        return "FHUSPM_SWU_FNUB_Release";
    }
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws Exception {
        FHUSPM_SWU_FNUB_Release algo = new FHUSPM_SWU_FNUB_Release();
