...
public class DescriptionFHUSPM_NON_Release extends DescriptionOfAlgorithm {
    public DescriptionFHUSPM_NON_Release() {
    }

    @Override
    public String getName() {
        return "FHUSPM_NON_Release";
    }
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws Exception {
        FHUSPM_NON_Release algo = new FHUSPM_NON_Release();
