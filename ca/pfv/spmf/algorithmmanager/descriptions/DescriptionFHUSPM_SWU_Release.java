...
import ca.pfv.spmf.algorithms.sequentialpatterns.FHUSPM.FHUSPM_NON_Release;
import ca.pfv.spmf.algorithms.sequentialpatterns.FHUSPM.FHUSPM_SWU_Release;

public class DescriptionFHUSPM_SWU_Release extends DescriptionOfAlgorithm {
    public DescriptionFHUSPM_SWU_Release() {
    }

    @Override
    public String getName() {
        return "FHUSPM_SWU_Release";
    }
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws Exception {
        FHUSPM_SWU_Release algo = new FHUSPM_SWU_Release();
