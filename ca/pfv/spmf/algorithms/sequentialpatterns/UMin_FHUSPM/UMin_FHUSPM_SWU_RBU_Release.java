package ca.pfv.spmf.algorithms.sequentialpatterns.UMin_FHUSPM;
...
public class UMin_FHUSPM_SWU_RBU_Release {
    /**
    ...
    public UMin_FHUSPM_SWU_RBU_Release() {
    }
    ...
    public void MineFHUS(SUL alpha) throws IOException {
        ...
        if (alpha.calcRBU() < minUtility) return;

        long utility = alpha.calcMinUtility();
    ...
    public void writeOutput(SUL sequence) throws IOException {
        patternCount++;
        writer.write(sequence.sequenceString + " -1 #UTIL: " + formatter.format(sequence.calcMinUtility()) + "\n");
    }
    ...
    public void printStatistics() {
        System.out.println("============   UMin_FHUSPM_SWU_RBU_Release   ===========");
