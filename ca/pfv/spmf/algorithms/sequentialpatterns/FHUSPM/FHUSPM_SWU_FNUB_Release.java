...
public class FHUSPM_SWU_FNUB_Release {
    /**
    ...
    public FHUSPM_SWU_FNUB_Release() {
    }
    ...
    public void MineFHUS(SULBigNumber alpha) throws IOException {
        ...
        if (alpha.calcFNub().compareTo(minUtility) < 0) return;
    ...
    public void printStatistics() {
        System.out.println("=============     FHUSPM_SWU_FNUB_Release     ===========");
